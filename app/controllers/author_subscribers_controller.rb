class AuthorSubscribersController < ApplicationController
  ...
  def donate
    ...
    AuthorSubscriber.create({author_id: author.id, subscriber_id: current_user.as_subscriber.id, is_paid: true})
  ...
  private
    ...
    def author_subscriber_params
      params.require(:author_subscriber).permit(:author_id, :subscriber_id, :is_paid)
    end
end
